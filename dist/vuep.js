(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('codemirror'), require('vue/dist/vue.common')) :
  typeof define === 'function' && define.amd ? define(['codemirror', 'vue/dist/vue.common'], factory) :
  (global.Vuep = factory(global.CodeMirror,global.Vue));
...
var Preview = {
  ...
  methods: {
    ...
    bindIframeResizeObserver: function bindIframeResizeObserver () {
      this.$el.contentWindow.addEventListener(
        'resize',
        this.resizeIframe
      );
    },
    unbindIframeResizeObserver: function unbindIframeResizeObserver () {
    ...
    bindIframeContentObserver: function bindIframeContentObserver () {
    ...
    unbindIframeContentObserver: function unbindIframeContentObserver () {
